...
class song:
    ...
    def __init__(self,features):
        ...
        self.features = [np.float64(features[7]), np.float64(features[10]), np.float64(features[12]), np.float(features[14]),\
                                    np.int_(features[15]), np.float64(features[20]), np.float64(features[1]),\
                                    np.float64(features[11]),np.float64(features[13]),np.float64(features[25]),np.float64(features[21])]
